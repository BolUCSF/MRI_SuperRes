...
from timm.layers import DropPath, to_3tuple, to_2tuple, trunc_normal_
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., rpb=True):
        ...
        if self.rpb:
            ...
            coords = torch.stack(torch.meshgrid([coords_h, coords_w,coords_d], indexing='xy'))  
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 drop_path=0., norm_layer=nn.LayerNorm, downsample=None, use_checkpoint=False, rpb=True):
...
class RSTB(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 img_size=224, patch_size=4, resi_connection='1conv', rpb=True):
...
class PatchEmbed3D(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None, level="second"):
        super().__init__()
    ...
    def forward(self, x):
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            if self.patch_size>1:
                ...
                temp = self.forward_features(x_first)
